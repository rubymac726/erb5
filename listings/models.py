...
# is_pulished shows the status of listing. Not display (default=False)
# (blank=True) means optional for the data field 
# (default=True) means compulsory for the data field 
